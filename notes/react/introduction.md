# <img src="/images/reactjs.png" alt="Blue atom" width="24" height="24"></img> Introduction to React
...
React is a [**JavaScript library**](/notes/javascript/javascript-library.md) (not a full framework) created by **Facebook (Meta)** in 2013. Its main purpose is to **build user interfaces (UI)**, especially [**single-page applications (SPAs)**](/notes/javascript/single-page-application.md) where the page dynamically updates without refreshing.
